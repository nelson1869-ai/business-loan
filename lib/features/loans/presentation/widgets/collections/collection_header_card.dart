...
class CollectionHeaderCard extends StatelessWidget {
  ...
  const CollectionHeaderCard({super.key, required this.collection});
  ...
  Widget build(BuildContext context) {
    ...
    final pendingCount = collection.dueItems.length - overdueCount;
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _HeaderStat(
                label: 'Total Tasks',
                value: '${collection.dueItems.length}',
                color: colorScheme.primary,
              ),
              _HeaderStat(
                label: 'Pending',
              ...
              _HeaderStat(
                label: 'Completed',
                value: '${(collection.dueItems.length * (pct / 100)).round()}',
                color: Colors.green,
              ),
            ],
          ),
